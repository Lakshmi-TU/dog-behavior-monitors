...
//
// Fix: destructures `activityData` from data — useLiveData now returns it.
// Previously it was destructured here but missing from the hook return value,
// causing ActivityChart to receive undefined and crash.
...
export default function Dashboard({ data }) {
  ...
  // ✅ activityData is now included — was missing from useLiveData return
  const {
    dogs, alerts, kpi,
    behaviorData, activityData, weeklyData,
    lastShock, exportCSV, dispatchTeam,
  } = data;
    ...
    <div className="flex-1 overflow-y-auto flex flex-col">
      ...
      <div className="p-5 px-6 flex-1">
        ...
        <div className="grid grid-cols-6 gap-3 mb-5">
          ...
          <StatCard label="Today's Alerts" value={kpi.alerts} sub={kpi.alertText}  color="red"    barWidth="60%"                               delay={0.25} />
        ...
        {/* ── Row 2: Behavior + Activity + Alerts ── */}
        <div className="grid grid-cols-3 gap-4 mb-4">
          <BehaviorChart data={behaviorData} />
          {/* ✅ activityData now always defined — no more undefined crash */}
        ...
        <div className="grid grid-cols-3 gap-4">
          ...
          <ControlPanel  lastShock={lastShock} onDispatch={dispatchTeam} dogs={dogs}/>
        </div>
